...
public class MainUpdate {
    ...
    public static void main(String[] args) {
        // add songs to album
        ArrayList<Song> albumOne = new ArrayList<Song>();
        ...
        ArrayList<Song> albumTwo = new ArrayList<Song>();
        ...
        album4.addSongToAlbum(Song.songBuilder("Good Morning" , 3256));
        album4.addSongToAlbum(Song.songBuilder("Take me Home", 308));

        playlist.add(album4.getSong(1));
        playlist.add(album4.getSong(2));
